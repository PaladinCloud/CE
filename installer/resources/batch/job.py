    ...
    container_properties = json.dumps({
        ...
        'environment': [
            ...
            {'name': "POLICY_DETAILS_URL",
             'value': ApplicationLoadBalancer.get_http_url() + "/api/compliance/policy-details"},
...
class SubmitAndQualysJobDefinition(BatchJobDefinitionResource):
    ...
    container_properties = json.dumps({
        ...
        'environment': [
            ...
            {'name': "POLICY_DETAILS_URL", 'value': ApplicationLoadBalancer.get_http_url() + "/api/compliance/policy-details"}
        ]
    })
