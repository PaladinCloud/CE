...
INSERT IGNORE INTO `cf_UpdateFlag` (`updateName`, `status`) VALUES ('filter_update_2024_07_02', 'started');
...
BEGIN
    ...
    FROM cf_UpdateFlag
    WHERE updateName = 'filter_update_2024_07_02';

    IF updateStatus = 'started' THEN
        /* update optionValue for filterId 1,8,14 */
        UPDATE pac_v2_ui_options
        SET optionValue = '_docid.keyword'
        WHERE filterId IN (1,8,14)
        AND optionId IN (26,31,52);
