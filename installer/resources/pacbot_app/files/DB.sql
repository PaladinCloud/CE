...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('reservedinstance','EC2 Reserved Instance','Reserved Instances','Compute','aws','{"key":"accountid,region,instanceid","id":"accountid,region,instanceid"}','','123',concat(@eshost,':',@esport,'/aws_reservedinstance/reservedinstance'),{d '2018-11-01'},{d '2018-11-01'},'Infra & Platforms');
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('route53','Route 53','Route 53','Networking & Content Delivery','aws','{"key":"accountid,region,hostedZoneId","id":"accountid,region,hostedZoneId"}','','123',concat(@eshost,':',@esport,'/aws_route53/route53'),{d '2019-08-03'},{d '2019-08-03'},'Infra & Platforms');
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('awsathena','Athena','AWS Athena Query services','Database','aws','{\"key\":\"accountid,region,queryid\",\"id\":\"accountid,region,queryid\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/aws_awsathena/awsathena'),'2022-05-06','2022-05-06','Infra & Platforms');
...
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,imageid\",\"id\":\"accountid,region,imageid\"}' where targetName = 'ami';
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,queryid\",\"id\":\"accountid,region,queryid\"}' where targetName = 'awsathena';
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,backupVaultArn\",\"id\":\"accountid,region,backupVaultArn\"}' where targetName = 'backupvault';
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,dbclusterresourceid\",\"id\":\"accountid,region,dbclusterresourceid\"}' where targetName = 'documentdb';
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,instanceid\",\"id\":\"accountid,region,instanceid\"}' where targetName = 'reservedinstance';
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,hostedZoneId\",\"id\":\"accountid,region,hostedZoneId\"}' where targetName = 'route53';
