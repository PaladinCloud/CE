...
update cf_Target set targetConfig='{"key":"id,databaseVersion","id":"id"}'  where dataSourceName="gcp" and targetName in ('cloudsql_mysqlserver','cloudsql_mysqlserver','cloudsql_postgres','cloudsql_sqlserver');
