...
-- This procedure create columns subscriptionName, assets and violations if not exists in table cf_AzureTenantSubscription
 DELIMITER $$
 DROP PROCEDURE IF EXISTS `alter_cf_azure_tenant_subscription` $$
 CREATE PROCEDURE alter_cf_azure_tenant_subscription()
 BEGIN
     IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
                    WHERE TABLE_SCHEMA = database() AND
                          TABLE_NAME = 'cf_AzureTenantSubscription' AND
                          COLUMN_NAME = 'subscriptionName') THEN
        ALTER TABLE cf_AzureTenantSubscription ADD COLUMN subscriptionName varchar(255) DEFAULT ' ';
     END IF;

     IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
                         WHERE TABLE_SCHEMA = database() AND
                               TABLE_NAME = 'cf_AzureTenantSubscription' AND
                               COLUMN_NAME = 'assets') THEN
          ALTER TABLE cf_AzureTenantSubscription ADD COLUMN assets int(20) DEFAULT 0;
     END IF;
 ...
 CALL alter_cf_azure_tenant_subscription();
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('asg','ASG','asg','Compute','aws','{"key":"autoscalinggrouparn","id":"autoscalinggrouparn"}','enabled',null,concat(@eshost,':',@esport,'/aws_asg/asg'),{d '2017-07-17'},{d '2017-07-17'},'Infra & Platforms');
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('dynamodb','DynamoDB','dynamodb','Database','aws','{"key":"tablearn","id":"tablearn"}','enabled',null,concat(@eshost,':',@esport,'/aws_dynamodb/dynamodb'),{d '2017-07-17'},{d '2017-07-17'},'Infra & Platforms');
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('lambda','Lambda','lambda','Compute','aws','{"key":"functionarn","id":"functionarn"}','enabled',null,concat(@eshost,':',@esport,'/aws_lambda/lambda'),{d '2017-07-17'},{d '2017-07-17'},'Infra & Platforms');
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('rdscluster','RDS Cluster','rdscluster','Database','aws','{"key":"dbclusterarn","id":"dbclusterarn"}','enabled',123,concat(@eshost,':',@esport,'/aws_rdscluster/rdscluster'),{d '2017-07-17'},{d '2018-08-03'},'Infra & Platforms');
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('targetgroup','Target Group','targetgroup','Compute','aws','{"key":"targetgrouparn","id":"targetgrouparn"}','enabled',null,concat(@eshost,':',@esport,'/aws_targetgroup/targetgroup'),{d '2017-07-17'},{d '2017-07-17'},'Infra & Platforms');
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('elasticache','ElastiCache','ElastiCache','Database','aws','{"key":"arn","id":"arn"}','enabled',null,concat(@eshost,':',@esport,'/aws_elasticache/elasticache'),{d '2017-11-13'},{d '2017-11-13'},'Infra & Platforms');
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('reservedinstance','EC2 Reserved Instance','Reserved Instances','Compute','aws','{"key":"accountid,region,instanceid","id":"instanceid"}','','123',concat(@eshost,':',@esport,'/aws_reservedinstance/reservedinstance'),{d '2018-11-01'},{d '2018-11-01'},'Infra & Platforms');
-- INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('route53','Route 53','Route 53','Networking & Content Delivery','aws','{"key":"accountid,region,hostedZoneId","id":"hostedZoneId"}','','123',concat(@eshost,':',@esport,'/aws_route53/route53'),{d '2019-08-03'},{d '2019-08-03'},'Infra & Platforms');
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('acmcertificate','ACM Certifcate','acmcertificate','Identity & Compliance','aws','{\"key\":\"accountid,region,domainname\",\"id\":\"domainname\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/aws_acmcertificate/acmcertificate'),'2019-02-15','2019-02-18','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('vminstance','VM','GCP Virtual Machine','Compute','gcp','{"key":"projectId,region,id","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_vminstance/vminstance'),'2022-06-01','2022-06-01','Infra & Platforms');
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('documentdb','DocumentDB','AWS Documentdb','Database','aws','{\"key\":\"accountid,region,dbclusterresourceid\",\"id\":\"dbclusterresourceid\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/aws_documentdb/documentdb'),'2022-05-06','2022-05-06','Infra & Platforms');
...
INSERT IGNORE INTO cf_Target (targetName,displayName,targetDesc,category,dataSourceName,targetConfig,status,userId,endpoint,createdDate,modifiedDate,domain) VALUES ('awsathena','Athena','AWS Athena Query services','Database','aws','{\"key\":\"accountid,region,queryid\",\"id\":\"queryid\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/aws_awsathena/awsathena'),'2022-05-06','2022-05-06','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('bigquerytable','BigQuery Table','GCP Bigquery Dataset table','BigQuery','gcp','{"key":"projectId,id","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_bigquerytable'),'2022-06-24','2022-06-24','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('bigquerydataset','BigQuery Dataset','GCP Bigquery Dataset','BigQuery','gcp','{"key":"projectId,id","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_bigquerydataset'),'2022-06-23','2022-06-23','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('batchaccounts','Batch Account','Azure batchaccounts','Compute','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_batchaccounts/batchaccounts'),'2019-09-19','2019-09-19','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('blobcontainer','Blob Container','Azure blobcontainer','Storage','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_blobcontainer/blobcontainer'),'2019-06-27','2019-06-27','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('loadbalancer','Load Balancer','Azure Loadbalancer','Networking','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled',NULL,concat(@eshost,':',@esport,'/azure_loadbalancer/loadbalancer'),'2019-11-05','2019-11-05','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('mysqlserver','MySQL Server','Azure mysqlserver','Databases','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_mysqlserver/mysqlserver'),'2019-06-27','2019-06-27','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('namespaces','Service Bus Namespace','Azure namespaces','Web','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_namespaces/namespaces'),'2019-09-19','2019-09-19','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('networkinterface','Network Interface','Azure Network Interface','Networking','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled',NULL,concat(@eshost,':',@esport,'/azure_networkinterface/networkinterface'),'2019-11-05','2019-11-05','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('nsg','NSG','Azure Network Security Group','Networking','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled',NULL,concat(@eshost,':',@esport,'/azure_nsg/nsg'),'2019-11-05','2019-11-05','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('postgresql','Postgre SQL','Azure postgresql','Databases','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_postgresql/postgresql'),'2019-06-27','2019-06-27','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('rediscache','Redis Cache','Azure rediscache','','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_rediscache/rediscache'),'2022-05-25','2022-05-25','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('securitypricings','Security Pricing','Azure Security Pricing','Security','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_securitypricings/securitypricings'),'2022-05-19','2022-05-19','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('dataproc','Dataproc Cluster','GCP dataproc clusters','Compute','gcp','{"key":"projectId,id","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_dataproc/dataproc'),'2022-07-19','2022-07-19','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('blobservice','Blob Service','Azure blobService','Storage','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_blobservice/blobservice'),'2022-09-15','2022-09-15','Infra & Platforms');
...
INSERT IGNORE INTO pac_config_properties (cfkey,value,application,profile,label,createdBy,createdDate,modifiedBy,modifiedDate) VALUES ('region.ignore','us-gov-east-1,us-gov-west-1,cn-north-1,cn-northwest-1,us-iso-east-1,us-iso-west-1,us-isob-east-1','inventory','prd','latest',null,null,null,null);
...
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('databricks','Azure databricks)','Analytics','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_databricks/databricks'),'2019-06-27','2019-06-27','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('disk','Azure Disk','Compute','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled',NULL,concat(@eshost,':',@esport,'/azure_disk/disk'),'2019-11-05','2019-11-05','Infra & Platforms');
...
START TRANSACTION;
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('securitycenter','Azure Security Center','Security','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','finding',NULL,concat(@eshost,':',@esport,'/azure_securitycenter/securitycenter'),'2019-11-05','2019-11-05','Infra & Platforms')
on DUPLICATE key update status='finding';
COMMIT;
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('sites','Sites','Azure sites','Internet of things','azure','{\"key\":\"id\",\"id\":\"id\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_sites/sites'),'2019-09-19','2019-09-19','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('sqldatabase','Azure SQL Database','Databases','azure','{\"key\":\"databaseId\",\"id\":\"databaseId\",\"name\":\"name\"}','enabled',NULL,concat(@eshost,':',@esport,'/azure_sqldatabase/sqldatabase'),'2019-11-05','2019-11-05','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('sqlserver','Azure sqlserver','Databases','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled',NULL,concat(@eshost,':',@esport,'/azure_sqlserver/sqlserver'),'2019-11-05','2019-11-05','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('storageaccount','Azure Object Storage Accounts','Storage','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled',NULL,concat(@eshost,':',@esport,'/azure_storageaccount/storageaccount'),'2019-11-05','2019-11-05','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('subnets','Azure subnets','Networking','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_subnets/subnets'),'2019-09-19','2019-09-19','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('vaults','Azure vaults','Security','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_vaults/vaults'),'2019-09-19','2019-09-19','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('vnet','Azure Disk','Networking','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled',NULL,concat(@eshost,':',@esport,'/azure_vnet/vnet'),'2019-11-05','2019-11-05','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`) VALUES('workflows','Azure workflows','Internet of things','azure','{\"key\":\"id\",\"id\":\"id\",\"name\":\"name\"}','enabled','admin@pacbot.org',concat(@eshost,':',@esport,'/azure_workflows/workflows'),'2019-09-19','2019-09-19','Infra & Platforms');
...
Update cf_Target set status = 'disabled' where targetName in ('asgpolicy','cloudwatchlogs','customergateway','datastream','deliverystream','dhcpoption','directconnect','iamgroup','internetgateway','nat','rdscluster','reservedinstance','route53','routetable','targetgroup','videostream','virtualinterface','vpnconnection','cosmosdb','diagnosticsetting','mariadb','publicipaddress','searchservices','securityalerts','sites','vaultsrbac');
...
-- unique id updates for target types
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,imageid\",\"id\":\"imageid\"}' where targetName = 'ami';
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,queryid\",\"id\":\"queryid\"}' where targetName = 'awsathena';
UPDATE cf_Target set targetConfig = '{\"key\":\"backupVaultArn\",\"id\":\"backupVaultArn\"}' where targetName = 'backupvault';
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,dbclusterresourceid\",\"id\":\"dbclusterresourceid\"}' where targetName = 'documentdb';
UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,instanceid\",\"id\":\"instanceid\"}' where targetName = 'reservedinstance';
-- UPDATE cf_Target set targetConfig = '{\"key\":\"accountid,region,hostedZoneId\",\"id\":\"hostedZoneId\"}' where targetName = 'route53';
DELETE from cf_Target  where targetName = 'route53';
UPDATE cf_Target set targetConfig = '{\"key\":\"autoscalinggrouparn\",\"id\":\"autoscalinggrouparn\"}' where targetName = 'asg';
UPDATE cf_Target set targetConfig = '{\"key\":\"tablearn\",\"id\":\"tablearn\"}' where targetName = 'dynamodb';
UPDATE cf_Target set targetConfig = '{\"key\":\"arn\",\"id\":\"arn\"}' where targetName = 'elasticache';
UPDATE cf_Target set targetConfig = '{\"key\":\"functionarn\",\"id\":\"functionarn"}' where targetName = 'lambda';
UPDATE cf_Target set targetConfig = '{\"key\":\"dbclusterarn\",\"id\":\"dbclusterarn\"}' where targetName = 'rdscluster';
UPDATE cf_Target set targetConfig = '{\"key\":\"dbclusterarn\",\"id\":\"dbclusterarn\"}' where targetName = 'rdsdb';
UPDATE cf_Target set targetConfig = '{\"key\":\"topicarn\",\"id\":\"topicarn"}' where targetName = 'snstopic';
...
LOOP
  ...
  INSERT IGNORE INTO pac_v2_ui_options (filterId,optionName,optionValue,optionURL) VALUES (1,_value,concat('tags.',_value,'.keyword'),'/compliance/v1/filters/attribute');
  ...
  INSERT IGNORE INTO pac_v2_ui_options (filterId,optionName,optionValue,optionURL) VALUES (8,_value,concat('tags.',_value,'.keyword'),'/compliance/v1/filters/attribute');
...
/* if value has alphabets, update createdTime to current timestamp */
IF(existing_date_var REGEXP '[a-z]' OR existing_date_var REGEXP '[A-Z]') THEN
UPDATE cf_Accounts SET createdTime=(SELECT CURRENT_TIMESTAMP) WHERE accountId=accountid_var;
ITERATE myloop;
/* if value is already in YYYY-MM-dd HH:mm:ss format, ignore and continue the loop. */
ELSEIF (existing_date_var REGEXP '[0-9]{4}-[0-9]{2}-[0-9]{2}[[:space:]][0-9]{2}:[0-9]{2}:[0-9]{2}') then
ITERATE myloop;
ELSE
...
INSERT IGNORE INTO `cf_Target` (`targetName`, `targetDesc`, `category`, `dataSourceName`, `targetConfig`, `status`, `userId`, `endpoint`, `createdDate`, `modifiedDate`, `domain`,displayName)
VALUES('mobile','Mobile','Compute','crowdstrike','{\"key\":\"externalAccountId,externalId\",\"id\":\"externalId\",\"name\":\"_resourcename\"}','enabled','admin@paladincloud.io',
concat(@eshost,':',@esport,'/crowdstrike_mobile'),now(),null,'Infra & Platforms','Mobile');
