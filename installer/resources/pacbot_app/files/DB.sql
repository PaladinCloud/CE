...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('vminstance','VM','GCP Virtual Machine','Compute','gcp','{"key":"accountid,region,id","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_vminstance/vminstance'),'2022-06-01','2022-06-01','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('bigquerytable','BigQuery Table','GCP Bigquery Dataset table','BigQuery','gcp','{"key":"accountid,id","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_bigquerytable'),'2022-06-24','2022-06-24','Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('bigquerydataset','BigQuery Dataset','GCP Bigquery Dataset','BigQuery','gcp','{"key":"accountid,id","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_bigquerydataset'),'2022-06-23','2022-06-23','Infra & Platforms');
...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('dataproc','Dataproc Cluster','GCP dataproc clusters','Compute','gcp','{"key":"accountid,id","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_dataproc/dataproc'),'2022-07-19','2022-07-19','Infra & Platforms');
