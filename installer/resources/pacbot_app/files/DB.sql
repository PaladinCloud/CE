...
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('cloudsql_sqlserver','SQL Server','GCP Cloud SQL Server','CloudSQLServer','gcp','{"key":"id,databaseVersion","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_cloudsql_sqlserver'),NOW(),NOW(),'Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('cloudsql_mysqlserver','MySQL Server','GCP Cloud MySQL Server','CloudMySQLServer','gcp','{"key":"id,databaseVersion","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_cloudsql_mysqlserver'),NOW(),NOW(),'Infra & Platforms');
INSERT IGNORE INTO `cf_Target` (`targetName`,`displayName`,`targetDesc`,`category`,`dataSourceName`,`targetConfig`,`status`,`userId`,`endpoint`,`createdDate`,`modifiedDate`,`domain`) VALUES ('cloudsql_postgres','PostgreSQL','GCP Cloud postgres Server','CloudPostgresServer','gcp','{"key":"id,databaseVersion","id":"id"}','enabled','admin',concat(@eshost,':',@esport,'/gcp_cloudsql_postgres'),NOW(),NOW(),'Infra & Platforms');
