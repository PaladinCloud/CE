...
INSERT IGNORE INTO `permission`(`permission_id`,`permission_name`,`permission_description`,`is_admin`) VALUES (22,'account-management','Permission to manage cloud accounts',true);
