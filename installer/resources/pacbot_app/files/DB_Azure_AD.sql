...
insert into pac_config_properties (cfkey,value,application,profile,label,createdby,createdDate) value ('azure.id-token.claims.email','unique_name','api','prd','latest','admin',now()) ON DUPLICATE KEY UPDATE `value`="unique_name";
