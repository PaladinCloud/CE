...
@Component
public class StorageAccountInventoryCollector implements Collector {

    private static final Logger log = LoggerFactory.getLogger(StorageAccountInventoryCollector.class);
    @Autowired
    ...
    public List<StorageAccountVH> collect(SubscriptionVH subscription, Map<String, Map<String, String>> tagMap) {
        List<StorageAccountVH> storageAccountList = new ArrayList<>();
