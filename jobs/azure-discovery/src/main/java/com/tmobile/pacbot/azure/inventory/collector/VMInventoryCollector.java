...
@Component
public class VMInventoryCollector implements Collector {

    private static final Logger log = LoggerFactory.getLogger(VMInventoryCollector.class);
    private final String apiUrlTemplate = "https://management.azure.com/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Compute/virtualMachines/%s?api-version=2023-03-01";
    @Autowired
    ...
    public List<VirtualMachineVH> collect(SubscriptionVH subscription, Map<String, Map<String, String>> tagMap) {
        ...
        for (VirtualMachine virtualMachine : vms) {
            try {
                ...
                vmVH.setPrimaryNetworkInterfaceId(virtualMachine.primaryNetworkInterfaceId());
