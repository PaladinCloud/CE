...
@Component
public class NetworkInventoryCollector implements Collector {

    private static final Logger log = LoggerFactory.getLogger(NetworkInventoryCollector.class);
    @Autowired
    ...
    public List<NetworkVH> collect(SubscriptionVH subscription, Map<String, Map<String, String>> tagMap) {
