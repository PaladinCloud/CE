...
@Component
public class NSGInventoryCollector implements Collector {

    private static final Logger log = LoggerFactory.getLogger(NSGInventoryCollector.class);
    @Autowired
    AzureCredentialProvider azureCredentialProvider;
    @Autowired
    NetworkWatcherInventoryCollector networkWatcherInventoryCollector;

    public List<SecurityGroupVH> collect(SubscriptionVH subscription, Map<String, Map<String, String>> tagMap) {
