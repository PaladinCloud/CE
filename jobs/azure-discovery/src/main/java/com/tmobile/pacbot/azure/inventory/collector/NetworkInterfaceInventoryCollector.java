...
@Component
public class NetworkInterfaceInventoryCollector implements Collector {

    private static final Logger log = LoggerFactory.getLogger(NetworkInterfaceInventoryCollector.class);
    @Autowired
    ...
    public List<NetworkInterfaceVH> collect(SubscriptionVH subscription,
        ...
        for (NetworkInterface networkInterface : networkInterfaces) {
            ...
            networkInterfaceVH.setRegion(Util.getRegionValue(subscription, networkInterface.regionName()));
    ...
    private void setipConfigurations(Map<String, NicIPConfiguration> ipConfigurations, NetworkInterfaceVH networkInterfaceVH) {
