...
public class FileGenerator {
    ...
    protected static String getLineData(String fieldNames, Object obj) {
        List<List<Object>> valueHolder = new ArrayList<>();
        String[] fieldNamesList = fieldNames.split("[" + DELIMITER + "]+");
    ...
    private static Field getField(Class<?> clazz, String name) {
        ...
        while (clazz != null) {
            try {
                ...
                log.error("Error getting value for {}", name, e);
            }
