...
public class AutofixNotificationRequest {
    ...
    private String autofixFailedReason;
    ...
    public String getAutofixFailedReason() {
        return autofixFailedReason;
    }

    public void setAutofixFailedReason(String autofixFailedReason) {
        this.autofixFailedReason = autofixFailedReason;
    }
