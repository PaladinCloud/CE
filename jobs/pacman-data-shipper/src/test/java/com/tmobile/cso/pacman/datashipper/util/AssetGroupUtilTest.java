...
public class AssetGroupUtilTest {
    ...
    public void testFetchPatchingCompliance() throws Exception {
        ...
        Map<String, Object> patchingInfo = AssetGroupUtil.fetchPatchingCompliance(anyString(), anyString());
    ...
    public void testFetchPatchingComplianceException() throws Exception {
        ...
        when(HttpUtil.get(anyString(), anyString())).thenReturn(patchingResponse);
        AssetGroupUtil.fetchPatchingCompliance(anyString(), anyString());
    ...
    public void testFetchVulnDistribution() throws Exception {
        ...
        List<Map<String, Object>> vulnDistribution = AssetGroupUtil.fetchVulnDistribution(anyString(), anyString());
    ...
    public void testFetchVulnDistributionException() throws Exception {
        ...
        when(HttpUtil.get(anyString(), anyString())).thenReturn(vulnResponse);
        AssetGroupUtil.fetchVulnDistribution(anyString(), anyString());
    }
    ...
    public void testFetchComplianceInfo() throws Exception {
        ...
        List<Map<String, Object>> complianceInfo = AssetGroupUtil.fetchComplianceInfo(anyString(), anyList());
    ...
    public void testFetchComplianceInfoException() throws Exception {
        ...
        when(HttpUtil.get(anyString(), anyString())).thenReturn(complResponse);
        AssetGroupUtil.fetchComplianceInfo(anyString(), anyList());
    }

    @Test
    public void testFetchRuleComplianceInfo() throws Exception {
        String ruleComplianceJson = "{\"data\":{\"response\":[{\"severity\":\"low\",\"name\":\"EBS snapshots should be tagged with mandatory tags \",\"compliance_percent\":50,\"lastScan\":\"2018-08-01T18:00:50.263Z\",\"ruleCategory\":\"tagging\",\"resourcetType\":\"snapshot\",\"policyId\":\"TaggingRule_version-1_SnapshotTaggingRule_snapshot\",\"assetsScanned\":55085,\"passed\":27619,\"failed\":27466,\"contribution_percent\":100},{\"severity\":\"low\",\"name\":\"Security groups should be tagged with mandatory tags\",\"compliance_percent\":18,\"lastScan\":\"2018-08-01T23:00:47.392Z\",\"ruleCategory\":\"tagging\",\"resourcetType\":\"sg\",\"policyId\":\"TaggingRule_version-1_SgTaggingRule_sg\",\"assetsScanned\":7129,\"passed\":1297,\"failed\":5832,\"contribution_percent\":100},{\"severity\":\"high\",\"name\":\"Amazon EBS volumes should not be underutilized \",\"compliance_percent\":84,\"lastScan\":\"2018-08-01T18:04:23.044Z\",\"ruleCategory\":\"costOptimization\",\"resourcetType\":\"volume\",\"policyId\":\"PacMan_Underutilized-Amazon-EBS-Volumes_version-1_Underutilized-EBS-Volumes_volume\",\"assetsScanned\":35938,\"passed\":30191,\"failed\":5747,\"contribution_percent\":100},{\"severity\":\"low\",\"name\":\"EBS volumes should be tagged with mandatory tags \",\"compliance_percent\":84,\"lastScan\":\"2018-08-01T23:00:55.626Z\",\"ruleCategory\":\"tagging\",\"resourcetType\":\"volume\",\"policyId\":\"TaggingRule_version-1_VolumeTaggingRule_volume\",\"assetsScanned\":35938,\"passed\":30227,\"failed\":5711,\"contribution_percent\":100},{\"severity\":\"low\",\"name\":\"Any Ec2 instance should not have S3 vulnerability \",\"compliance_percent\":30,\"lastScan\":\"2018-08-01T18:00:26.570Z\",\"ruleCategory\":\"security\",\"resourcetType\":\"ec2\",\"policyId\":\"PacMan_Ec2WithSeverityVulnerability_version-1_Ec2WithS3Vulnerability_ec2\",\"assetsScanned\":7192,\"passed\":2172,\"failed\":5020,\"contribution_percent\":100}]}}";
        when(HttpUtil.post(anyString(), anyString(), anyString(), anyString())).thenReturn(ruleComplianceJson);
        List<Map<String, Object>> complianceInfo = AssetGroupUtil.fetchPolicyComplianceInfo(anyString(), anyList());
        assertThat(complianceInfo.size(), is(5));
        assertThat(complianceInfo.get(0).get("domain").toString(), is("infra"));
        assertThat(complianceInfo.get(0).get("policyId").toString(), is("TaggingRule_version-1_SnapshotTaggingRule_snapshot"));
    }

    @Test(expected = Exception.class)
    public void testFetchRuleComplianceInfoException() throws Exception {
        String ruleComplianceJson = "{\"data1\":{\"response\":[{\"severity\":\"low\",\"name\":\"EBS snapshots should be tagged with mandatory tags \",\"compliance_percent\":50,\"lastScan\":\"2018-08-01T18:00:50.263Z\",\"ruleCategory\":\"tagging\",\"resourcetType\":\"snapshot\",\"policyId\":\"TaggingRule_version-1_SnapshotTaggingRule_snapshot\",\"assetsScanned\":55085,\"passed\":27619,\"failed\":27466,\"contribution_percent\":100},{\"severity\":\"low\",\"name\":\"Security groups should be tagged with mandatory tags\",\"compliance_percent\":18,\"lastScan\":\"2018-08-01T23:00:47.392Z\",\"ruleCategory\":\"tagging\",\"resourcetType\":\"sg\",\"policyId\":\"TaggingRule_version-1_SgTaggingRule_sg\",\"assetsScanned\":7129,\"passed\":1297,\"failed\":5832,\"contribution_percent\":100},{\"severity\":\"high\",\"name\":\"Amazon EBS volumes should not be underutilized \",\"compliance_percent\":84,\"lastScan\":\"2018-08-01T18:04:23.044Z\",\"ruleCategory\":\"costOptimization\",\"resourcetType\":\"volume\",\"policyId\":\"PacMan_Underutilized-Amazon-EBS-Volumes_version-1_Underutilized-EBS-Volumes_volume\",\"assetsScanned\":35938,\"passed\":30191,\"failed\":5747,\"contribution_percent\":100},{\"severity\":\"low\",\"name\":\"EBS volumes should be tagged with mandatory tags \",\"compliance_percent\":84,\"lastScan\":\"2018-08-01T23:00:55.626Z\",\"ruleCategory\":\"tagging\",\"resourcetType\":\"volume\",\"policyId\":\"TaggingRule_version-1_VolumeTaggingRule_volume\",\"assetsScanned\":35938,\"passed\":30227,\"failed\":5711,\"contribution_percent\":100},{\"severity\":\"low\",\"name\":\"Any Ec2 instance should not have S3 vulnerability \",\"compliance_percent\":30,\"lastScan\":\"2018-08-01T18:00:26.570Z\",\"ruleCategory\":\"security\",\"resourcetType\":\"ec2\",\"policyId\":\"PacMan_Ec2WithSeverityVulnerability_version-1_Ec2WithS3Vulnerability_ec2\",\"assetsScanned\":7192,\"passed\":2172,\"failed\":5020,\"contribution_percent\":100}]}}";
        when(HttpUtil.post(anyString(), anyString(), anyString(), anyString())).thenReturn(ruleComplianceJson);
        AssetGroupUtil.fetchPolicyComplianceInfo(anyString(), anyList());
    }
    ...
    public void testFetchIssuesInfo() throws Exception {
        ...
        List<Map<String, Object>> issueDistribution = AssetGroupUtil.fetchIssuesInfo(anyString(), anyList());
    ...
    public void testFetchIssuesInfoException() throws Exception {
        ...
        when(HttpUtil.get(anyString(), anyString())).thenReturn(issueDistrJson);
        AssetGroupUtil.fetchIssuesInfo(anyString(), anyList());
    }
}
