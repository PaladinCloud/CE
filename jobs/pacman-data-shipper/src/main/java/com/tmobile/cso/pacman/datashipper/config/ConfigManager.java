...
public class ConfigManager {
    ...
    private static final String TARGET_TYPE_INFO = "targetTypes";
    private static final String CONFIG_CREDS = "config_creds";
    private static final String TARGET_TYPE_OUTSCOPE = "typesNotInScope";
    ...
    private static Map<String, Map<String, String>> getTypeConfig(String datasoruce) {
        ...
        String commaSepTargetTypes = System.getProperty(TARGET_TYPE_INFO);
        ...
        String outscopeTypes = System.getProperty(TARGET_TYPE_OUTSCOPE);
