...
@PacmanPolicy(key = "check-bigquery-table-encryption-with-cmks", desc = "Enable BigQuery Encryption with Customer-Managed Keys", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)

public class TableKeyEncryptionRule extends BasePolicy {
