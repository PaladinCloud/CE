...
@PacmanPolicy(key = "check-for-asg-referencing-inactive-sg", desc = "checks for ASG launch configuration referencing missing security group", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class AutoScalingGroupsWithMissingSG extends BasePolicy {
