...
@PacmanRule(key = "check-for-Tls-version-rule", desc = "Check web App is using the latest version of TLS encryption", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class CheckForTlsVersionRule extends BaseRule {
