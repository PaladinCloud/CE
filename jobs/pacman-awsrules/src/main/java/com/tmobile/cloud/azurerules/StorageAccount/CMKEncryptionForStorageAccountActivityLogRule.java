...
@PacmanRule(key = "check-for-storageAcc-activitylog-encryption", desc = "Azure activity log storage container is encrypted with BYOK (Bring Your Own Key) ", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class CMKEncryptionForStorageAccountActivityLogRule extends BaseRule {
