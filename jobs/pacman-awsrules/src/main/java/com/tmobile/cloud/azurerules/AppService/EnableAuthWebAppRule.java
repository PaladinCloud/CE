...
@PacmanPolicy(key = "check-if-auth-enabled-app-service", desc = "enable authentication for azure app service", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnableAuthWebAppRule extends BasePolicy {
