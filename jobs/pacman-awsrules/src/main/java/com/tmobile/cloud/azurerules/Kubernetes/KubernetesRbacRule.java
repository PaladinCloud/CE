...
import java.util.*;
@PacmanRule(key = "enable-rbac-role-for-kubernetes", desc = "Ensure 'All users with following rules' is set to owner in security alert emails", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class KubernetesRbacRule extends BaseRule {
