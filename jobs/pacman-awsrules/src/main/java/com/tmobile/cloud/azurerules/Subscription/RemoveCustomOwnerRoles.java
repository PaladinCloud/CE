...
import java.util.*;
@PacmanPolicy(key="check-for-custom-owner-roles", desc = "Subscription ownership should not include permission to create custom owner roles.", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class RemoveCustomOwnerRoles extends BasePolicy {
