...
@PacmanRule(key = "enable-cluster-monitoring-for-kubernetes", desc = "Enable azure AKS cluster monitoring", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnableClusterMonitoring extends BaseRule {
