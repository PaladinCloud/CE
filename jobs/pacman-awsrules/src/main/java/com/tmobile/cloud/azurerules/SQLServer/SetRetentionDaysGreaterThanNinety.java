...
import java.util.*;
@PacmanRule(key = "check-if-retention-days-is-greater-than-ninety", desc = "Retention days should be greater than 90 days", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class SetRetentionDaysGreaterThanNinety extends BaseRule {
