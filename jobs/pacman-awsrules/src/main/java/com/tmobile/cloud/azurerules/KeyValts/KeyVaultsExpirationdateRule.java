...
@PacmanPolicy(key = "key-should-have-expiration-date", desc = "key vaults keys should have expiration date", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class KeyVaultsExpirationdateRule extends BasePolicy {
    private static final Logger logger = LoggerFactory.getLogger(KeyVaultsExpirationdateRule.class);

    @Override
    public PolicyResult execute(Map<String, String> ruleParam, Map<String, String> resourceAttributes) {
        logger.info("Executing KeyVaultsExpirationdateRule");
        ...
        if (!StringUtils.isNullOrEmpty(resourceId)) {
            ...
            try {
                isValid = checkkeyVaultKeyExpirationDate(esUrl, mustFilter);
                if (!isValid) {
    ...
    private boolean checkkeyVaultKeyExpirationDate(String esUrl, Map<String, Object> mustFilter) throws Exception {
