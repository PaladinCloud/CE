...
@PacmanPolicy(key = "check-subnet-mode-is-legacy-vpc", desc = "Ensure legacy subnet mode VPC not being used in the project", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class SubnetmodeRule extends BasePolicy {
