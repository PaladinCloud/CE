...
@PacmanPolicy(key = "least-privilege-service-accounts", desc = "Deny admin Privileges to service accounts", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class PrincipleOfLeastPrivilegeRule extends BasePolicy {
