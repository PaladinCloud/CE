...
import java.util.*;
@PacmanRule(key = "enable-private-cluster-for-kubernetes", desc = "Enable the private cluster feature for your Azure Kubernetes Service cluster to ensure network traffic between your API server and your node pools remains on the private network only", severity = PacmanSdkConstants.SEV_LOW, category = PacmanSdkConstants.SECURITY)
public class KubernetesPrivateClusterEnableRule extends BaseRule {
