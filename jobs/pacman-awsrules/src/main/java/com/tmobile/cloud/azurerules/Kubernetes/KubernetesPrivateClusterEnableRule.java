...
import java.util.*;
@PacmanPolicy(key = "enable-private-cluster-for-kubernetes", desc = "Enable the private cluster feature for your Azure Kubernetes Service cluster to ensure network traffic between your API server and your node pools remains on the private network only", severity = PacmanSdkConstants.SEV_LOW, category = PacmanSdkConstants.SECURITY)
public class KubernetesPrivateClusterEnableRule extends BasePolicy {
    private static final Logger logger = LoggerFactory.getLogger(KubernetesPrivateClusterEnableRule.class);
    @Override
    public PolicyResult execute(Map<String, String> ruleParam, Map<String, String> resourceAttributes) {
        logger.info("Executing KubernetesPrivateClusterEnableRule..");
    ...
    public String getHelpText() {
        return "This rule checks if private Cluster is enabled for kubernetes";
    }
}
