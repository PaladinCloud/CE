...
@PacmanRule(key = "check-for-functionapp-incoming-certificate-enabled", desc = "checks if incoming certificate is enabled", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class IncomingClientCertificateShouldBeEnabled extends BaseRule {
