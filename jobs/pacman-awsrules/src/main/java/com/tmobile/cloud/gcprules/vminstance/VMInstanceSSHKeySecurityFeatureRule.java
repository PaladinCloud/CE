...
import java.util.*;
@PacmanRule(key = "check-for-block-project-ssh-key", desc = "checks if instance-level SSH keys is enabled", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class VMInstanceSSHKeySecurityFeatureRule extends BaseRule {
