...
@PacmanPolicy(key = "enable-confidential-computing-instance", desc = "enable ensure confidential compute instance", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnableConfidentialInstanceRule extends BasePolicy {
