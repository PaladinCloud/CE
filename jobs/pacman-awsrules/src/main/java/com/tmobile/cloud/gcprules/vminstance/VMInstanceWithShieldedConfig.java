...
@PacmanRule(key = "check-if-vminstance-has-shielded-config", desc = "checks if virtual machine instance has shielded config", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class VMInstanceWithShieldedConfig extends BaseRule {
