...
@PacmanPolicy(key = "check-cloudwatch-alarm-exists", desc = "This rule checks for log metric filter and alarm exists", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class LogMetricFilterAndAlarmRule extends BasePolicy {
	 ...
	 */
	@Override
	public PolicyResult execute(final Map<String, String> ruleParam, final Map<String, String> resourceAttributes) {
