...
@PacmanRule(key = "check-for-vpc-network-firewall-outbound-security", desc = "checks for vpc network public IP address", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class VPCNetworkOutboundRule extends BaseRule {
