...
public class VPCNetworkOutboundRule extends BasePolicy {
    ...
    public PolicyResult execute(Map<String, String> ruleParam, Map<String, String> resourceAttributes) {
        ...
        if (StringUtils.isEmpty(resourceId)) {
            ...
            logger.debug("========VPCNetworkOutboundPolicy ended with an annotation {} : =========", annotation);
        ...
        try {
            if (!GCPFirewallUtils.verifyPorts(vmEsURL, mustFilter, port, PacmanRuleConstants.EGRESS)) {
        ...
        logger.debug("========VPCNetworkOutboundPolicy ended=========");
