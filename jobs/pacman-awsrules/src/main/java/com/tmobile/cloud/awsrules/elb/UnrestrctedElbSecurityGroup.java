...
@PacmanPolicy(key = "check-for-elb-unrestrcted-security-group", desc = "This rule checks for elb security group port which is not configured in the listener security", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class UnrestrctedElbSecurityGroup extends BasePolicy {
