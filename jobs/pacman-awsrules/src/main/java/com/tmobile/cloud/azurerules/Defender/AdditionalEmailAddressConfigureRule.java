...
@PacmanPolicy(key = "configure-additional-email-address-ms-defender", desc = "In MS defender email alert settings, Ensure additional email address is configured.", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class AdditionalEmailAddressConfigureRule extends BasePolicy{
