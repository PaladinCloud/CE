...
@PacmanPolicy(key = "check-for-vminstance-serviceaccount-cloud-access", desc = "Deny usage of service accounts with full cloud API access for VM instances", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class VMInstanceServiceAccountCloudAPIAccess extends BasePolicy {
