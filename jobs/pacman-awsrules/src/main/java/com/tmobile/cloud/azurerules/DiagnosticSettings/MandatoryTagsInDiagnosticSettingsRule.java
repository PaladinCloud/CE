...
@PacmanPolicy(key = "check-if-diagnostic-setting-has-mandatory-tags", desc = "Mandatory tags must be present in diagnostic settings", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class MandatoryTagsInDiagnosticSettingsRule extends BasePolicy {
