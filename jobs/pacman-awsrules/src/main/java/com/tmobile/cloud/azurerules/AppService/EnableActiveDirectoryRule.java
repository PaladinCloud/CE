...
@PacmanPolicy(key = "check-if-active-directory-enabled", desc = "Check active directory is enabled on app services", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnableActiveDirectoryRule extends BasePolicy {
