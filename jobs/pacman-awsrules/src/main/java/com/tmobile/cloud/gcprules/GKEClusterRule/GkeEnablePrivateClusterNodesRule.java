...
import java.util.*;
@PacmanPolicy(key = "ensure-clusters-with-private-nodes", desc = "Ensure clusters are created with Private Nodes", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class GkeEnablePrivateClusterNodesRule extends BasePolicy{
