...
@PacmanPolicy(key = "check-for-vm-two-factor-authentication", desc = "checks if virtual machine has two factor authentication", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class VMTwoFactorAuthentication extends BasePolicy {
