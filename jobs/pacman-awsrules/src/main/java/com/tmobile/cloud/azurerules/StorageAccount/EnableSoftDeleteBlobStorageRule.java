...
@PacmanPolicy(key = "enable-soft-delete-for-blob-storage-account", desc = "Ensure that Soft Delete feature is enabled for all your Microsoft Azure Storage blob objects", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnableSoftDeleteBlobStorageRule extends BasePolicy {
