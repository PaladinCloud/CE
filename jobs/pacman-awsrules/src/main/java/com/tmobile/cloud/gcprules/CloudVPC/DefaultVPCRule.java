...
@PacmanPolicy(key = "check-default-vpc-used-in-project", desc = "Ensure default VPC not being used in the project", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class DefaultVPCRule extends BasePolicy {
