...
import java.util.*;
@PacmanPolicy(key = "disable-basic-authentication", desc = "Disable Basic Authentication using static passwords", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class DisableBasicAuthenticationRule extends BasePolicy {
