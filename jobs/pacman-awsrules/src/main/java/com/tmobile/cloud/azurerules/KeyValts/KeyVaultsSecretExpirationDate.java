...
@PacmanRule(key = "secret-should-have-expiration-date", desc = "key vaults secrets should have expiration date", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class KeyVaultsSecretExpirationDate extends BaseRule {
