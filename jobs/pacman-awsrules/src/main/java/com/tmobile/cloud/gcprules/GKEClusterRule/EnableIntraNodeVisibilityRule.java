...
@PacmanPolicy(key = "check-intraNode-visibility",desc = "Enable VPC Flow Logs and Intranode Visibility to see pod-level traffic, even for traffic within a worker node.", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnableIntraNodeVisibilityRule extends BasePolicy  {
