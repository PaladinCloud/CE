...
@PacmanPolicy(key = "check-for-stopped-instance-for-long", desc = "checks entirely for stopped instance for more than 30 days", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.GOVERNANCE)
public class EC2StoppedInstanceForLongRule extends BasePolicy {
