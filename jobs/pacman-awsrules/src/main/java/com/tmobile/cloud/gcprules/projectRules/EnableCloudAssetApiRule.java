...
@PacmanPolicy(key = "enable-cloud-asset-api",desc = "Ensure cloud asset api is enabled",severity = PacmanRuleConstants.MEDIUM,category = PacmanSdkConstants.SECURITY)
public class EnableCloudAssetApiRule extends BasePolicy {
