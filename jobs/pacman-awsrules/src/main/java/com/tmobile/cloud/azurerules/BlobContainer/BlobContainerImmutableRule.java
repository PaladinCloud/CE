...
@PacmanRule(key = "check-if-blob-container-is-immutable", desc = "azure blob container should be immutable", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class BlobContainerImmutableRule extends BaseRule {
