...
@PacmanRule(key = "check-if-cloud-storage-has-public-access", desc = "checks if cloud storage has public access", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class CloudStorageWithPublicAccessRule extends BaseRule {
