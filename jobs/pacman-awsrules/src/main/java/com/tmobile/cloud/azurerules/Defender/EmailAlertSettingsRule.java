...
@PacmanRule(key = "set-all-users-to-owner-email-notification", desc = "Ensure 'All users with following rules' is set to owner in security alert emails", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EmailAlertSettingsRule extends BaseRule {
