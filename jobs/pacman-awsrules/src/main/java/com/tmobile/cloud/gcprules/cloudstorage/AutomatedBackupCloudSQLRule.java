...
@PacmanPolicy(key = "check-if-cloud-storage-has-automated-backups-enabled", desc = "check if the automated backups are enabled for all Cloud SQL database instances.", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class AutomatedBackupCloudSQLRule extends BasePolicy {
