...
@PacmanPolicy(key = "define-authorised-ip-ranges-for-kubernetes", desc = "Define authorised IP ranges for AKS API server", severity = PacmanSdkConstants.SEV_LOW, category = PacmanSdkConstants.SECURITY)
public class DefineAuthorisedIPRanges extends BasePolicy {
