...
@PacmanRule(key = "check-for-microsoft-sql-database-unrestricted-acesss", desc = "unrestricted access for sql database", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class UnrestrictedSqlDatabaseAccessRule extends BaseRule {
