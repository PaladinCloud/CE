...
@PacmanPolicy(key = "check-endpoint-protection-installed-for-virtual-machines", desc = "Azure policy for checking azure virtual machines have endpoint protection installed", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class EndpointProtectionRule extends BasePolicy {
