...
@PacmanPolicy(key = "restrict-default-network-access", desc = "Restrict Default Network Access for Storage Accounts", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class DefaultNetworkAccess extends BasePolicy {
