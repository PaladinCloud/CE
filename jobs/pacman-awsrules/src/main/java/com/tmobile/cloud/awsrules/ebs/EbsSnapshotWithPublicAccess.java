...
@PacmanPolicy(key = "check-for-ebs-snapshot-with-public-access", desc = "checks entirely for EBS snapshot with public access", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class EbsSnapshotWithPublicAccess extends BasePolicy {
