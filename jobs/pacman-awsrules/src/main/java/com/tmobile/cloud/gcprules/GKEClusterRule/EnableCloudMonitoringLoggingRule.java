...
@PacmanRule(key = "enable-cloud-logging-monitoring", desc = "Enable Cloud Logging Monitoring", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnableCloudMonitoringLoggingRule extends BaseRule {
