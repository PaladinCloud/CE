...
@PacmanPolicy(key = "check-for-remote-debugging-app-service", desc = "deny remote debugging for azure app service", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class DenyRemoteDebuggingWebAppRule extends BasePolicy {
    private static final Logger logger = LoggerFactory
            .getLogger(DenyRemoteDebuggingWebAppRule.class);
    private static final String RESOURCE_NOT_FOUND = "Resource data not found!!Skipping this validation";
    @Override
    public PolicyResult execute(Map<String, String> ruleParam, Map<String, String> resourceAttributes) {
        logger.info("Executing remote debugging for azure app service rule .");
        ...
        if (!StringUtils.isNullOrEmpty(resourceId)) {
            ...
            try {
                isValid = validateRemoteDeubggingforAppService(esUrl, mustFilter);
            } catch (Exception e) {
            ...
            if (!isValid) {
                ...
                annotation.put(PacmanSdkConstants.DESCRIPTION,
                        "remote debugging for azure app service is enabled");
                ...
                logger.debug("remote debugging for azure app service with FAILURE isValid flag {} : ",
                        isValid);
    ...
    private boolean validateRemoteDeubggingforAppService(String esUrl, Map<String, Object> mustFilter) throws Exception {
    ...
    public String getHelpText() {
        return "This rule will check remote debugging for azure app service ";
    }
}
