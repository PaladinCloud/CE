...
@PacmanRule(key = "check-for-remote-debugging-app-service", desc = "deny remote debugging for azure app service", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class DenyRemoteDebuggingWebAppRule extends BaseRule {
