...
@PacmanRule(key = "check-for-https-only-rule", desc = "enable https only", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class HttpsOnlyRule extends BaseRule {
