...
@PacmanRule(key = "ip-forward-rule", desc = "disable ip forwarding for GCE instance and enable for GKE instance", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class IPFowardingRule  extends BaseRule {
