...
@PacmanPolicy(key = "enable-node-pool-managements", desc = "Enable  GKE nodes management properties", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnableNodeAutoUpgrade extends BasePolicy {
