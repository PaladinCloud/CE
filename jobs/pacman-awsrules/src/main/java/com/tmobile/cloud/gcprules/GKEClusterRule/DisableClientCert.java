...
@PacmanPolicy(key = "Disable-client-certificate-Authentication-for-GKE-Cluster", desc = "Disable  client certificate Authentication for GKE cluster", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class DisableClientCert extends BasePolicy {
