...
@PacmanRule(key = "encrypt-App-layer-secret-in-GKE-Cluster", desc = "check encryption enable in Application-Layer secrets for GKE CLuster", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class AppLayerSecretsEncryptionRule extends BaseRule {
