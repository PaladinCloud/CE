...
@PacmanPolicy(key = "encrypt-App-layer-secret-in-GKE-Cluster", desc = "check encryption enable in Application-Layer secrets for GKE CLuster", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class AppLayerSecretsEncryptionRule extends BasePolicy {

    private static final Logger logger = LoggerFactory.getLogger(AppLayerSecretsEncryptionRule.class);
    ...
    public String getHelpText() {
        return "check Application-Layer Secrets encryption enabled for GKE CLuster";
    }
}
