...
@PacmanRule(key = "check-for-vpc-network-firewall-security-uncommon-ports", desc = "checks for vpc network public IP address", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class VPCFirewallUncommonports extends BaseRule {
