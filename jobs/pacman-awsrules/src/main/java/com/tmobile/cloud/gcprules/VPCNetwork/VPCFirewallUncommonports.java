...
@PacmanPolicy(key = "check-for-vpc-network-firewall-security-uncommon-ports", desc = "checks for vpc network public IP address", severity = PacmanSdkConstants.SEV_HIGH, category = PacmanSdkConstants.SECURITY)
public class VPCFirewallUncommonports extends BasePolicy {
    private static final Logger logger = LoggerFactory.getLogger(VPCFirewallUncommonports.class);
    ...
    public PolicyResult execute(Map<String, String> ruleParam, Map<String, String> resourceAttributes) {
        ...
        if (StringUtils.isEmpty(resourceId)) {
            ...
            logger.debug("========VPCFirewallUncommonPortsPolicy ended with an annotation {} : =========", annotation);
        ...
        logger.debug("========VPCFirewallUncommonPortsPolicy ended=========");
