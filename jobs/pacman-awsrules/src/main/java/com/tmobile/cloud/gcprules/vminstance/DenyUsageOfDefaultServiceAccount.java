...
@PacmanPolicy(key = "deny-usage-of-default-service-account", desc = "Deny usage of default service accounts", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class DenyUsageOfDefaultServiceAccount extends BasePolicy {
