...
@PacmanPolicy(key = "enforce-ssl-to-cloud-sql", desc = "enforce-ssl-cloud-sql", severity = PacmanSdkConstants.SEV_MEDIUM, category = PacmanSdkConstants.SECURITY)
public class EnforceSSLToCloudSQL extends BasePolicy {
