...
public class GKEPrivateNodesRuleTest {

    @InjectMocks
    GkeEnablePrivateClusterNodesRule enablePrivateClusterNodesRule;
    @Before
    public void setUp() {
    ...
    public void executeSuccessTest() throws Exception {
        ...
        when(PacmanUtils.doesAllHaveValue(anyString(), anyString(), anyString())).thenReturn(
                true);
        assertThat(enablePrivateClusterNodesRule.execute(getMapString("r_123 "), getMapString("r_123 ")).getStatus(),
    ...
    public void getHelpTextTest() {
        assertThat(enablePrivateClusterNodesRule.getHelpText(), is(notNullValue()));
    }
}
