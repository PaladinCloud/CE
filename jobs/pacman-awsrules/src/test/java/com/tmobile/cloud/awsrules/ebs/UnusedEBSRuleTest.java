...
public class UnusedEBSRuleTest {

    @InjectMocks
    UnusedEBSRule unusedEBSRule;
    ...
    public void executeTest() throws Exception {
        ...
        assertThat(unusedEBSRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 ")), is(notNullValue()));
        ...
        assertThatThrownBy( 
                () -> unusedEBSRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 "))).isInstanceOf(RuleExecutionFailedExeption.class);
        
        when(PacmanUtils.doesAllHaveValue(anyString(),anyString(),anyString())).thenReturn(
                false);
        assertThatThrownBy(
                () -> unusedEBSRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 "))).isInstanceOf(InvalidInputException.class);
    }
    
    @Test
    public void getHelpTextTest(){
        assertThat(unusedEBSRule.getHelpText(), is(notNullValue()));
    }
}
