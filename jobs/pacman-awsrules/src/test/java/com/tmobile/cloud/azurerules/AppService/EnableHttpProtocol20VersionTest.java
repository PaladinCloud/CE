...
public class EnableHttpProtocol20VersionTest {
    @InjectMocks
    EnableHttpProtocol20Version enableHttpProtocol20Version;
    ...
    public void executeSucessTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(), anyObject(),
                ...
                .thenReturn(getHitJsonArrayForRemoteDebugging());
        assertThat(enableHttpProtocol20Version.execute(CommonTestUtils.getMapString("r_123 "),
    ...
    public void executeFailureTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(), anyObject(),
                anyObject(),
                anyObject(), anyObject(), anyInt(), anyObject(), anyObject(), anyObject()))
                .thenReturn(getFailureJsonArrayForRemoteDebugging());
        assertThat(enableHttpProtocol20Version.execute(CommonTestUtils.getMapString("r_123 "),
    ...
    public void getHelpTextTest() {
        assertThat(enableHttpProtocol20Version.getHelpText(), is(notNullValue()));
    }
