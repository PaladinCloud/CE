...
public class UnrestrictedSqlDatabaseAccessRuleTest {
    ...
    public void executeTest() throws Exception {
        ...
        assertThatThrownBy(
                () -> unrestrictedSqlDatabaseAccessRule.execute(CommonTestUtils.getMapString("r_123 "),
                        CommonTestUtils.getMapString("r_123 ")))
                .isInstanceOf(RuleExecutionFailedExeption.class);

        assertThatThrownBy(
                () -> unrestrictedSqlDatabaseAccessRule.execute(CommonTestUtils.getOneMoreMapString("r_123 "),
                        CommonTestUtils.getMapString("r_123 ")))
                .isInstanceOf(RuleExecutionFailedExeption.class);
