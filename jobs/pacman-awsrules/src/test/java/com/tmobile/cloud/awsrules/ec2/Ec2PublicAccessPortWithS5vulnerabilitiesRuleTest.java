...
public class Ec2PublicAccessPortWithS5vulnerabilitiesRuleTest {

    @InjectMocks
    Ec2PublicAccessPortWithS5vulnerabilitiesRule ec2PublicAccessPortWithS5vulnerabilitiesRule;
    ...
    public void executeTest() throws Exception {
        ...
        when(PacmanUtils.doesAllHaveValue(anyString(),anyString(),anyString(),anyString(),anyString(),anyString())).thenReturn(
                false);
        assertThatThrownBy(
                () -> ec2PublicAccessPortWithS5vulnerabilitiesRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 "))).isInstanceOf(InvalidInputException.class);
        
    }
    
    @Test
    public void getHelpTextTest(){
        assertThat(ec2PublicAccessPortWithS5vulnerabilitiesRule.getHelpText(), is(notNullValue()));
    }
