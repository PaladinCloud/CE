...
public class DefineAuthorisedIPRangesTest {
    @InjectMocks
    DefineAuthorisedIPRanges defineAuthorisedIPRanges;
    @Test
    public void executeSucessTest() throws Exception {
        ...
        assertThat(defineAuthorisedIPRanges.execute(CommonTestUtils.getMapString("r_123 "),
    ...
    public void getHelpTextTest() {
        assertThat(defineAuthorisedIPRanges.getHelpText(), is(notNullValue()));
    }
}
