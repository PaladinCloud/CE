...
public class RDSDBPublicAcessRuleTest {

    @InjectMocks
    RDSDBPublicAcessRule rdsdbPublicAcessRule;
    ...
    public void executeTest() throws Exception {
        ...
        assertThat(rdsdbPublicAcessRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 ")), is(notNullValue()));
        ...
        assertThatThrownBy( 
                () -> rdsdbPublicAcessRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 "))).isInstanceOf(RuleExecutionFailedExeption.class);
        
        when(PacmanUtils.doesAllHaveValue(anyString(),anyString(),anyString(),anyString(),anyString(),anyString(),anyString(),anyString(),anyString(),anyString())).thenReturn(
                false);
        assertThatThrownBy(
                () -> rdsdbPublicAcessRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 "))).isInstanceOf(InvalidInputException.class);
    }
    ...
    public void getHelpTextTest(){
        assertThat(rdsdbPublicAcessRule.getHelpText(), is(notNullValue()));
    }
}
