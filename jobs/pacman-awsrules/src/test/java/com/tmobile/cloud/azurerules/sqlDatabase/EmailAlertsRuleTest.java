...
import com.tmobile.cloud.azurerules.policies.EmailAlertsRule;
...
public class EmailAlertsRuleTest {
    ...
    @InjectMocks
    EmailAlertsRule emailAlertsRule;

    public JsonObject getFailureJsonArrayForemailAlertsRule() {
        Gson gson = new Gson();
    ...
    public  JsonObject getHitJsonArrayForemailAlertsRule() {
        Gson gson = new Gson();
        JsonObject jsonObject = new JsonObject();
    ...
    public void executeSucessTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(), anyObject(), anyObject(),
                anyObject(), anyObject(), anyInt(), anyObject(), anyObject(), anyObject())).thenReturn(getHitJsonArrayForemailAlertsRule());
    ...
    public void getHelpTextTest() {
        assertThat(emailAlertsRule.getHelpText(), is(notNullValue()));
    }
