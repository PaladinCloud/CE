...
public class EC2PublicAccessForConfiguredPortRuleTest {

    @InjectMocks
    EC2PublicAccessForConfiguredPortRule accessForConfiguredPortRule;
    ...
    public void executeTest() throws Exception {
        ...
        assertThat(accessForConfiguredPortRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 ")), is(notNullValue()));
        ...
        assertThatThrownBy( 
                () -> accessForConfiguredPortRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 "))).isInstanceOf(RuleExecutionFailedExeption.class);
        ...
        assertThat(accessForConfiguredPortRule.execute(CommonTestUtils.getOneMoreMapString("r_123 "),CommonTestUtils.getOneMoreMapString("r_123 ")), is(notNullValue()));
    ...
    public void getHelpTextTest(){
        assertThat(accessForConfiguredPortRule.getHelpText(), is(notNullValue()));
    }
