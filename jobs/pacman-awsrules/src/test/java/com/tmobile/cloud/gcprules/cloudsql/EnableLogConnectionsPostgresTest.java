...
public class EnableLogConnectionsPostgresTest {
    @InjectMocks
    ...
    public void executeSuccessTest() throws Exception {
        ...
        when(GCPUtils.getHitsArrayFromEs(anyObject(), anyObject())).thenReturn(getHitjsonArrayForLogConnectionsDBFlag());
    ...
    public void executeFailureTest() throws Exception {
        ...
        when(PacmanUtils.getPacmanHost(anyString())).thenReturn("host");
        when(GCPUtils.getHitsArrayFromEs(anyObject(), anyObject())).thenReturn(getFailureHitjsonArrayForLogConnectionsDBFlag());
    ...
    public static Map<String, String> getMapString(String passRuleResourceId) {
        ...
        commonMap.put("ruleId", "Enable_Log_connections_for_Postgres_Server_DB_Instances");
        commonMap.put("policyId", "Enable_Log_connections_for_Postgres_Server_DB_Instances");
        commonMap.put("policyVersion", "version-1");
        commonMap.put("dataBaseType", "gcp_cloudsql_postgres");
        commonMap.put("dbFlagName", "log_connections");
        commonMap.put("dbFlagValue", "on");
        commonMap.put("description", "Ensure that log_connections database flag is enabled for your Google Cloud PostgreSQL database instances. The log_connections flag causes each attempted connection to the database instance to be logged, including successful client authentication request");
        commonMap.put("violationReason", "log_connections flag is disabled for your Google Cloud postgres Server database instances");
