...
public class DeleteUnusedDiskRuleTest {
    @InjectMocks
    DeleteUnusedDiskRule deleteUnusedDiskRule;

    public JsonObject getFailureForUnusedDisk() {
        Gson gson = new Gson();
    ...
    public JsonObject getHitJsonArrayForUnusedDisk() {
        Gson gson = new Gson();
        JsonObject jsonObject = new JsonObject();
        jsonObject.add("hits", gson.fromJson(
                "{\n" +
    ...
    public void executeSucessTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(), anyObject(),
                ...
                .thenReturn(getHitJsonArrayForUnusedDisk());
        assertThat(deleteUnusedDiskRule.execute(CommonTestUtils.getMapString("r_123 "),
    ...
    public void executeFailureTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(), anyObject(),
                anyObject(),
                anyObject(), anyObject(), anyInt(), anyObject(), anyObject(), anyObject()))
                .thenReturn(getFailureForUnusedDisk());
    ...
    public void getHelpTextTest() {
        assertThat(deleteUnusedDiskRule.getHelpText(), is(notNullValue()));
    }
