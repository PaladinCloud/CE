...
public class EnableQuicProtocolRuleTest {
    @InjectMocks
    EnableQuicProtocolRule enableQuicProtocolRule;
    ...
    public void executeSuccessTest() throws Exception {
        ...
        when(PacmanUtils.doesAllHaveValue(anyString(), anyString(), anyString())).thenReturn(
                true);
        assertThat(enableQuicProtocolRule.execute(getMapString("r_123 "), getMapString("r_123 ")).getStatus(),
    ...
    public void executeFailureTestWithInvalidInputException() throws Exception {
        ...
        assertThatThrownBy(() -> enableQuicProtocolRule.execute(map, map)).isInstanceOf(InvalidInputException.class);
    }
    ...
    public void getHelpTextTest() {
        assertThat(enableQuicProtocolRule.getHelpText(), is(notNullValue()));
    }
}
