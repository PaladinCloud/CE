...
public class CheckHTTPDeniedRuleTest {
	...
	public void s3BucketWithoutValidPolicy() throws Exception {
		...
		PolicyResult ruleResult = checkHTTPDeniedRule.execute(ruleParam, resourceAttribute);
	...
	private Map<String, String> getInputParamMap() {
		...
		ruleParam.put(PacmanSdkConstants.POLICY_ID, "S3BucketAllowHTTPRequest_version-1_S3BucketAllowHTTPRequest_s3");
