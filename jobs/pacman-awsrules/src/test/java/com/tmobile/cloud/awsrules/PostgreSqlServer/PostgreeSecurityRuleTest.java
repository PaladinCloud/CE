package com.tmobile.cloud.awsrules.PostgreSqlServer;
...
import com.tmobile.cloud.azurerules.PostgreSqlServer.PostgreeSecurityRule;
...
public class PostgreeSecurityRuleTest {
    @InjectMocks
    PostgreeSecurityRule postgreeSecurityRule;
