...
public class BlobContainerImmutableRuleTest {
    ...
    public void executeTest() throws Exception {
        ...
        assertThat(blobContainerImmutableRule.execute(getMapNotExistString("r_123 "), getMapNotExistString("r_123 ")),
                is(notNullValue()));

        when(PacmanUtils.getPacmanHost(anyString())).thenReturn("host");

        when(PacmanUtils.checkISResourceIdExistsFromElasticSearch("_resourceid", "azure_blobcontainer/_search", "", ""))
                .thenReturn(true);
        when(PacmanUtils.doesAllHaveValue(anyString(), anyString(), anyString())).thenReturn(false);
        assertThatThrownBy(
                () -> blobContainerImmutableRule.execute(getMapString("r_123 "), getMapString("r_123 ")))
    ...
    public static Map<String, String> getMapString(String passRuleResourceId) {
        ...
        commonMap.put("ruleId",
                "Enable_Azure_BlobContainer_Immutability");
        commonMap.put("policyId", "Enable_Azure_BlobContainer_Immutability");
