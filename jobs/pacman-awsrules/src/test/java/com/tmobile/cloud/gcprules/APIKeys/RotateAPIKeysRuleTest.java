...
import static com.tmobile.cloud.gcprules.utils.TestUtils.getFailuresonArrayForAPIKeyApplication;
import static com.tmobile.cloud.gcprules.utils.TestUtils.getHitJsonArrayForAPIKeyApplication;
...
public class RotateAPIKeysRuleTest {
    @InjectMocks
    RotateAPIKeysRule rotateAPIKeysRule;
    ...
    public void executeSuccessTest() throws Exception {
        ...
        when(PacmanUtils.doesAllHaveValue(anyString(), anyString(), anyString())).thenReturn(
                true);
        assertThat(rotateAPIKeysRule.execute(getMapString("r_123 "), getMapString("r_123 ")).getStatus(), is(PacmanSdkConstants.STATUS_SUCCESS));
    ...
    public void executeFailureTest() throws Exception {
        ...
        when(PacmanUtils.doesAllHaveValue(anyString(), anyString(), anyString())).thenReturn(
                true);
        assertThat(rotateAPIKeysRule.execute(getMapString("r_123 "), getMapString("r_123 ")).getStatus(), is(PacmanSdkConstants.STATUS_FAILURE));
    }
    ...
    public void executeFailureTestWithInvalidInputException() throws Exception {
        ...
        when(PacmanUtils.doesAllHaveValue(anyString(), anyString(), anyString())).thenReturn(
                false);
        assertThatThrownBy(() -> rotateAPIKeysRule.execute(getMapString("r_123 "), getMapString("r_123 "))).isInstanceOf(InvalidInputException.class);
    }
    ...
    public void getHelpTextTest() {
        assertThat(rotateAPIKeysRule.getHelpText(), is(notNullValue()));
    }
}
