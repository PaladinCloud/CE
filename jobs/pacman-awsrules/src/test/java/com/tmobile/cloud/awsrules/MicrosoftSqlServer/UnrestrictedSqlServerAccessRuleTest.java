package com.tmobile.cloud.awsrules.MicrosoftSqlServer;
...
public class UnrestrictedSqlServerAccessRuleTest {
    @InjectMocks
    UnrestrictedSqlServerAccessRule unrestrictedSqlServerAccessRule;
    ...
    public void executeTest() throws Exception {
        ...
        assertThat(unrestrictedSqlServerAccessRule.execute(CommonTestUtils.getMapString("r_123 "),
        ...
        assertThatThrownBy(
                () -> unrestrictedSqlServerAccessRule.execute(CommonTestUtils.getMapString("r_123 "),
                        CommonTestUtils.getMapString("r_123 ")))
                .isInstanceOf(RuleExecutionFailedExeption.class);

        assertThatThrownBy(
                () -> unrestrictedSqlServerAccessRule.execute(CommonTestUtils.getOneMoreMapString("r_123 "),
                        CommonTestUtils.getMapString("r_123 ")))
                .isInstanceOf(RuleExecutionFailedExeption.class);
    ...
    public void getHelpTextTest() {
        assertThat(unrestrictedSqlServerAccessRule.getHelpText(), is(notNullValue()));
    }
