...
import com.tmobile.cloud.azurerules.SQLDatabase.EnableTransparentDataEncryptionRule;
...
public class EnableTransparentDataEncryptionRuleTest {

    @InjectMocks
    EnableTransparentDataEncryptionRule enableTransparentDataEncryptionRule;

    public JsonObject getFailureJsonArrayForTDE() {
        Gson gson = new Gson();
    ...
    public  JsonObject getHitJsonArrayForTDE() {
        Gson gson = new Gson();
        JsonObject jsonObject = new JsonObject();
    ...
    public void executeSucessTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(),anyObject(),
                anyObject(),
                anyObject(), anyObject(), anyInt(), anyObject(), anyObject(), anyObject())).thenReturn(getHitJsonArrayForTDE());
        assertThat(enableTransparentDataEncryptionRule.execute(CommonTestUtils.getMapString("r_123 "),
    ...
    public void executeFailureTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(),anyObject(),
                anyObject(),
                anyObject(), anyObject(), anyInt(), anyObject(), anyObject(), anyObject())).thenReturn(getFailureJsonArrayForTDE());
        assertThat(enableTransparentDataEncryptionRule.execute(CommonTestUtils.getMapString("r_123 "),
    ...
    public void getHelpTextTest() {
        assertThat(enableTransparentDataEncryptionRule.getHelpText(), is(notNullValue()));
    }
