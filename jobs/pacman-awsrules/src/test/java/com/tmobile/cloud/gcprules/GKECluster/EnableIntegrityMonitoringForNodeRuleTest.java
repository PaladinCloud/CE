...
public class EnableIntegrityMonitoringForNodeRuleTest {
    ...
    @InjectMocks
    EnableNodeAutoUpgrade enableIntegrityMonitoringForNodeRule;
    @Before
    public void setUp() {
    ...
    private JsonArray getHitsJsonForGKEIntegrityMonitoringSuccess() {
        Gson gson = new Gson();
    ...
    public static Map<String, String> getMapString(String passRuleResourceId) {
        ...
        commonMap.put("violationReason", "Integrity monitoring is not enabled for node pool of gke cluster");
        commonMap.put("esSgRulesUrl", "/gcp_gkecluster/_search");
        commonMap.put("nodePoolKey","enableIntegrityMonitoring");
        return commonMap;
    }

    @Test
    public void getHelpTextTest() {
        assertThat(enableIntegrityMonitoringForNodeRule.getHelpText(), is(notNullValue()));
    }
}
