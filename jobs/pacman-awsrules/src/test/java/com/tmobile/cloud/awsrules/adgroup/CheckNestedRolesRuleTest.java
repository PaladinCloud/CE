...
public class CheckNestedRolesRuleTest {
    ...
    @InjectMocks
    CheckNestedRolesRule checkNestedRolesRule;
    ...
    public void executeTest() throws Exception {
        ...
        assertThatThrownBy( 
                () -> checkNestedRolesRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 "))).isInstanceOf(RuleExecutionFailedExeption.class);
        
        when(PacmanUtils.doesAllHaveValue(anyString(),anyString(),anyString())).thenReturn(
                false);
        assertThatThrownBy(
                () -> checkNestedRolesRule.execute(CommonTestUtils.getMapString("r_123 "),CommonTestUtils.getMapString("r_123 "))).isInstanceOf(InvalidInputException.class);
    }
    
    @Test
    public void getHelpTextTest(){
        assertThat(checkNestedRolesRule.getHelpText(), is(notNullValue()));
    }
