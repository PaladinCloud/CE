...
public class ConfigureApiRestrictionTest {
    ...
    @InjectMocks
    ConfigureApiRestriction configureApiRestriction;
    ...
    public static Map<String, String> getMapString(String passRuleResourceId) {
        ...
        commonMap.put("ruleId", "Enable_API_Key_Restrictions");
    ...
    public void getHelpTextTest() {
        assertThat(configureApiRestriction.getHelpText(), is(notNullValue()));
    }
}
