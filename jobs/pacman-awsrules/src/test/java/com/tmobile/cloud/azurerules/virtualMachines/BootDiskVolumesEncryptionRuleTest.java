...
public class BootDiskVolumesEncryptionRuleTest {
    ...
    public JsonObject getFailureJsonArrayForBootDiskVolumeEncryption(){
        Gson gson=new Gson();
    ...
    public  JsonObject getHitJsonArrayForBootDiskVolumeEncryption() {
        Gson gson = new Gson();
        JsonObject jsonObject = new JsonObject();
    ...
    public void executeSucessTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(),anyObject(),
                anyObject(),
                anyObject(), anyObject(), anyInt(), anyObject(), anyObject(), anyObject())).thenReturn(getHitJsonArrayForBootDiskVolumeEncryption());
    ...
    public void executeFailureTest() throws Exception {
        ...
        when(RulesElasticSearchRepositoryUtil.getQueryDetailsFromES(anyString(),anyObject(),
                anyObject(),
                anyObject(), anyObject(), anyInt(), anyObject(), anyObject(), anyObject())).thenReturn(getFailureJsonArrayForBootDiskVolumeEncryption());
        assertThat(bootDiskVolumesEncryptionRule.execute(CommonTestUtils.getMapString("r_123 "),
