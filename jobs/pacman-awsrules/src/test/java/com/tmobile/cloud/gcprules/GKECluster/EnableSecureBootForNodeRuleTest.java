...
public class EnableSecureBootForNodeRuleTest {
    @InjectMocks
    EnableNodeAutoUpgrade enableSecureBootForNodeRule;
    @Before
    public void setUp() {
    ...
    public void executeSuccessTest() throws Exception {
        ...
        when(PacmanUtils.doesAllHaveValue(anyString(), anyString(), anyString())).thenReturn(
                true);
        assertThat(enableSecureBootForNodeRule.execute(getMapString("r_123 "), getMapString("r_123 ")).getStatus(),
    ...
    public void getHelpTextTest() {
        assertThat(enableSecureBootForNodeRule.getHelpText(), is(notNullValue()));
    }
}
