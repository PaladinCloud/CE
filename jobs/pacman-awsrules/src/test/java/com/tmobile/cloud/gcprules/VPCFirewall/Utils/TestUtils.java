...
public class TestUtils {
    ...
    public static JsonArray getHitsJsonArrayForVPCFIreWallEgress() {
        Gson gson = new Gson();
        JsonObject jsonObject = new JsonObject();
        jsonObject.add("_source", gson.fromJson("{\n" +
                "          \"_cloudType\": \"GCP\",\n" +
    ...
    public static JsonArray getHitsJsonArrayForVPCFIreWallWithMultiplePorts() {
        Gson gson = new Gson();
        JsonObject jsonObject = new JsonObject();
        jsonObject.add("_source", gson.fromJson("{\n" +
                "          \"_cloudType\": \"GCP\",\n" +
    ...
    public static JsonArray getHitsJsonArrayForVPCFIreWallWithRangeOfPorts() {
        Gson gson = new Gson();
        JsonObject jsonObject = new JsonObject();
        jsonObject.add("_source", gson.fromJson("{\n" +
                "          \"_cloudType\": \"GCP\",\n" +
