...
public class RDSDBUnencryptedPublicAcessRuleTest {

    @InjectMocks
    RDSDBUnencryptedPublicAccessRule rdsBbUnencryptedPublicAccessRule;
    ...
    public void executeTest() throws Exception {
        ...
        assertThat(rdsBbUnencryptedPublicAccessRule.execute(getMapString("r_123 "),getMapString("r_123 ")), is(notNullValue()));
        assertThat(rdsBbUnencryptedPublicAccessRule.execute(getMapStringEncrypted("r_123 "),getMapStringEncrypted("r_123 ")), is(notNullValue()));
        when(PacmanUtils.doesAllHaveValue(anyString(),anyString())).thenReturn(
                false);
        assertThatThrownBy(
                () -> rdsBbUnencryptedPublicAccessRule.execute(getMapString("r_123 "),getMapString("r_123 "))).isInstanceOf(InvalidInputException.class);
    }
    
    @Test
    public void getHelpTextTest(){
        assertThat(rdsBbUnencryptedPublicAccessRule.getHelpText(), is(notNullValue()));
    }
