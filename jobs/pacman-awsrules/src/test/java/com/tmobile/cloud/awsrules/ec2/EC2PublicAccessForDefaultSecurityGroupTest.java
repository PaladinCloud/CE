...
public class EC2PublicAccessForDefaultSecurityGroupTest {

    @InjectMocks
    EC2PublicAccessForDefaultSecurityGroup ec2WithDefaultSecurityGroup;
    ...
    public void executeTest() throws Exception {
        ...
        when(PacmanUtils.getDefaultSecurityGroupsByInstanceId(anyString(),anyString(),anyString())).thenReturn(getListSecurityGroupId());
    ...
    public static Map<String, String> getMapString(String passRuleResourceId) {
        ...
        commonMap.put("ruleId", "PacMan_AwsEc2PublicAccessDefaultSecurityGroup_version-1_AwsEc2PublicAccessDefaultSecurityGroup_ec2");
        commonMap.put("policyId", "PacMan_AwsEc2PublicAccessDefaultSecurityGroup_version-1");
