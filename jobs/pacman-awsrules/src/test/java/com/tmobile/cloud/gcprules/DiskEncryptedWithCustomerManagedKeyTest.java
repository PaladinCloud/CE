...
public class DiskEncryptedWithCustomerManagedKeyTest {
    @InjectMocks
    DiskEncryptedWithCustomerManagedKey diskEncryptedWithCustomerManagedKey;
    @Test
    public void executeTest() throws Exception {
        mockStatic(PacmanUtils.class);
        when(PacmanUtils.doesAllHaveValue(anyString(), anyString(), anyString())).thenReturn(true);
        assertThat(diskEncryptedWithCustomerManagedKey.execute(getMapNotExistString("r_123 "), getMapNotExistString("r_123 ")),
                is(notNullValue()));
        ...
        assertThatThrownBy(
                () -> diskEncryptedWithCustomerManagedKey.execute(getMapString("r_123 "), getMapString("r_123 ")))
    ...
    public static Map<String, String> getMapString(String passRuleResourceId) {
        ...
        commonMap.put("policyId", "GCP_Virtual_Machine_Disk_Encryption_CMK_Rule");
    ...
    public void getHelpTextTest() {
        assertThat(diskEncryptedWithCustomerManagedKey.getHelpText(), is(notNullValue()));
    }
}
