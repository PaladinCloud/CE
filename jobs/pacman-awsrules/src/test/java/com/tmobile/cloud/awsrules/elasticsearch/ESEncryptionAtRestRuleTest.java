...
public class ESEncryptionAtRestRuleTest {

	@InjectMocks
	ESEncryptionAtRestRule esEncryptionAtRestRule;

	@Test
	public void esWithEncryption() {
		...
		PolicyResult ruleResult = esEncryptionAtRestRule.execute(ruleParam, resourceAttribute);
	...
	public void getHelpTextTest() {
		assertThat(esEncryptionAtRestRule.getHelpText(), is(notNullValue()));
	}
