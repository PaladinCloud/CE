...
public class IngressSettingRuleTest {

    @InjectMocks
    IngressSettingRule ingressSettingRule;
    ...
    private JsonArray getHitsJsonArrayForIngressSettingRule(){
        Gson gson = new Gson();
        ...
        jsonObject.add("_source", gson.fromJson(
                " {\n" +
                        ...
                        "          \"ingressSetting\": \"Allow internal traffic only\",\n" +
    ...
    public void getHelpTextTest() {
        assertThat(ingressSettingRule.getHelpText(), is(notNullValue()));
    }
}
