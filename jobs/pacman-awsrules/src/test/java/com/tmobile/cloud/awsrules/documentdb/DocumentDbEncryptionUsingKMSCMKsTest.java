...
public class DocumentDbEncryptionUsingKMSCMKsTest {

    @InjectMocks
    DocumentDbEncryptionUsingKMSCMKs documentDbEncryptionUsingKMSCMKs;
    ...
    public void executeTest() throws Exception {
        ...
        assertThatThrownBy(
                () -> documentDbEncryptionUsingKMSCMKs.execute(getMapString("r_123 "),getMapString("r_123 "))).isInstanceOf(InvalidInputException.class);
        
    }
    
    @Test
    public void getHelpTextTest(){
        assertThat(documentDbEncryptionUsingKMSCMKs.getHelpText(), is(notNullValue()));
    }
    ...
    public static Map<String, String> getMapString(String passRuleResourceId) {
        ...
        commonMap.put("ruleId", "Aws_DocumentDB_should_be_encrypted_with_kms_cmks_version-1_aws_kms_cmks_encryption_should_be_enabled_documentdb");
        commonMap.put("policyId", "Aws_DocumentDB_should_be_encrypted_with_kms_cmks_version-1");
