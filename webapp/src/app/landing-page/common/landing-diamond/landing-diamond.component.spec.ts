...
describe('LandingDiamondComponent', () => {
  let component: LandingDiamondComponent;
  let fixture: ComponentFixture<LandingDiamondComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LandingDiamondComponent);
