 ...
 */
 ...
 export const MAPPING = {
    ...
    '_resourceid.keyword': 'Asset ID',
    'targetType.keyword': 'Asset Type',
    'policyCategory.keyword': 'policy Category',
    ...
    'issueidlist': 'Violation ID List',
    'requeststatus': 'Request Status',
    'commentforlastaction': 'Admin Remarks',
    'resourceidlist': 'Asset ID List',
    ...
    'root devicetype': 'Root Device Type'
};
