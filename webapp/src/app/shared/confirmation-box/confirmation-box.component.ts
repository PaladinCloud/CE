...
export class ConfirmationBoxComponent implements OnInit, OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges) {
        ...
        if (transactionInProgressChanges) {
            ...
            if (
                transactionInProgressChanges.currentValue !==
                transactionInProgressChanges.previousValue
            ) {
        ...
        if (transactionResponseChanges) {
            ...
            console.log(transactionResponseChanges);
            if (
                transactionResponseChanges.currentValue !== transactionResponseChanges.previousValue
            ) {
