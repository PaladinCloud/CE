...
export class EventDetailsComponent implements OnInit, OnDestroy {
    ...
    requestNewException() {
        ...
        this.cbprocessData =
            this.exceptionMangamentService.createDataToAddOrModifyException(exceptionRawInput);
    }
    ...
    getDescription() {
        ...
        try {
            this.getDescriptionSubscription = this.commonResponseService
    ...
    getAutofixDetails() {
        ...
        try {
            this.getAutofixSubscription = this.commonResponseService
                ...
                .subscribe(
                    (response) => {
                        try {
                            ...
                            this.inputToException['allTargetTypes'] = [
                                this.autofixData.resourceType,
                            ];
                            this.inputToException['disablePolicy'] = true;
                            this.responseStatusInfo.loadState = 1;
                        } catch (e) {
    ...
    goToDetails(row) {
        try {
            if (row.col.toLowerCase() === 'resource id') {
                ...
                this.router
                    .navigate(['../../../', 'assets', 'asset-list', targetType, resourceId], {
