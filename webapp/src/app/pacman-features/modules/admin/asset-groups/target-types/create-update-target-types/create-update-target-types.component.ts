...
export class CreateUpdateTargetTypesComponent implements OnInit, OnDestroy {
    ...
    createTargetType(targetTypes) {
        ...
        this.adminService.executeHttpAction(url, method, targetTypeDetails, {}).subscribe(
            (reponse) => {
    ...
    getDomainAndCategoryDetails() {
        ...
        this.adminService.executeHttpAction(url, method, {}, {}).subscribe(
            (domainsReponse) => {
                ...
                this.adminService
                    .executeHttpAction(targetCategoryUrl, targetCategoryMethod, {}, {})
                    .subscribe(
                        (categoryReponse) => {
    ...
    getTargetTypeDetails(targetTypeName) {
        ...
        this.adminService
            .executeHttpAction(url, method, {}, { targetTypeName: targetTypeName })
            .subscribe(
                (reponse) => {
                    ...
                    this.targetTypes.dataSource = [
                        {
                            text: this.allSelectedTargettypeDetails.dataSourceName,
                            id: this.allSelectedTargettypeDetails.dataSourceName,
                        },
                    ];
                },
                (error) => {
