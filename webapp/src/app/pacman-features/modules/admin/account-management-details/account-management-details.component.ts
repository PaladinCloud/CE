...
export class AccountManagementDetailsComponent implements OnInit, OnDestroy {
            ...
            .subscribe((responseData) => {
                try {
                    ...
                    if (status.toLowerCase() == 'success') {
                        nofificationMessage =
                            'Account ' + this.accountId + ' has been deleted successfully';
    ...
    getData() {
        ...
        this.commonResponseService.getData(url, method, payload, {}).subscribe((responseData) => {
    ...
    processData(data) {
        ...
        if (this.status.toLowerCase() == 'configured') this.chipList.push('Online');
        else this.chipList.push('Offline');
    }
