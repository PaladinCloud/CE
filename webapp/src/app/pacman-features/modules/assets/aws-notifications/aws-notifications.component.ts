...
@Component({
    ...
    providers: [IssueListingService, LoggerService, ErrorHandlingService],
})
        ...
        try {
            ...
            if (this.activatedRoute.snapshot.queryParams) {
                ...
                if (
                    ...
                    this.activatedRoute.snapshot.queryParams.filter !== undefined
                ) {
                    this.FullQueryParams = this.activatedRoute.snapshot.queryParams;
                    this.queryParamsWithoutFilter = Object.keys(this.FullQueryParams)
                        .slice(1)
                        .map((key) => ({ [key]: this.FullQueryParams[key] }));
                    const obj = {};
