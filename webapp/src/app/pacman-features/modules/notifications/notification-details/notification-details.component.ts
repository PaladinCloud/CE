...
export class NotificationDetailsComponent implements OnInit, OnDestroy {
    ...
    formatDescription(description){
      ...
      if (description.indexOf("https://console.aws.amazon.com/ec2/v2/home?region=us-west-2#Events") > 0) {
        description = description.replaceAll("https://console.aws.amazon.com/ec2/v2/home?region=us-west-2#Events",
      ...
      if (description.indexOf("https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Stop_Start.html") > 0) {
        description = description.replaceAll("https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Stop_Start.html",
      ...
      if (description.indexOf("https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Events") > 0) {
        description = description.replaceAll("https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Events",
      ...
      if (description.indexOf("[3] https://github.com/awslabs/aws-vpn-migration-scripts") > 0) {
        description = description.replaceAll("[3] https://github.com/awslabs/aws-vpn-migration-scripts",
      ...
      if (description.indexOf("(https://aws.amazon.com/support)") > 0) {
        description = description.replaceAll("(https://aws.amazon.com/support)",
      ...
      if (description.indexOf("(http://aws.amazon.com/support)") > 0) {
        description = description.replaceAll("(http://aws.amazon.com/support)",
      ...
      if (description.indexOf("[1] https://console.aws.amazon.com") > 0) {
        description = description.replaceAll("[1] https://console.aws.amazon.com",
      ...
      if (description.indexOf("http://aws.amazon.com/architecture") > 0) {
        description = description.replaceAll("http://aws.amazon.com/architecture",
      ...
      if (description.indexOf("https://nodejs.org/en/blog/release/v6.9.0/") > 0) {
        description = description.replaceAll("https://nodejs.org/en/blog/release/v6.9.0/",
      ...
      description = description.replaceAll("[1]", "").replaceAll("[2]", "").replaceAll("[3]", "").replaceAll("[4]", "")
          .replaceAll("[NL][NL]", "<br><br>").replaceAll("(https:", "<a href=\"https:").replaceAll("[NL]", "<br>")
          .replaceAll(" [3]", "").replaceAll("[NL]", "<br>");
