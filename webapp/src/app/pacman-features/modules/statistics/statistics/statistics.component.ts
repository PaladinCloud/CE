...
export interface StatsResponse {
    ...
    numberOfPolicyWithAutoFixesAvailable: number;
    numberOfPolicyWithAutoFixesEnabled: number;
...
export class StatisticsComponent implements OnInit {
    ...
    companyIcon = CONFIGURATIONS.optional.general.logo.CustomerLogo || '/assets/images/Paladin_Logo.svg'; 
    ...
    numberOfPolicyWithAutoFixesAvailable: number = 0;
    numberOfPolicyWithAutoFixesEnabled: number = 0;
    ...
    private updateStatCounters(data: StatsResponse) {
        ...
        this.numberOfPolicyWithAutoFixesAvailable = data.numberOfPolicyWithAutoFixesAvailable;
        this.numberOfPolicyWithAutoFixesEnabled = data.numberOfPolicyWithAutoFixesEnabled;
    }
