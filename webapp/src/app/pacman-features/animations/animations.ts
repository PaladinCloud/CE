...
import { trigger, state, animate, style, transition, query, keyframes } from '@angular/animations';
...
export const fadeInOutDiamond = trigger('fadeInOutDiamond', [
    state(
        'show',
        style({
            opacity: '1',
