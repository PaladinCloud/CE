...
describe('DevStandardPullRequestAgeComponent', () => {
  let component: DevStandardPullRequestAgeComponent;
  let fixture: ComponentFixture<DevStandardPullRequestAgeComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DevStandardPullRequestAgeComponent);
