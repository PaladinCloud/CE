...
import { HostVulnerabilitiesComponent } from './host-vulnerabilities.component';

describe('HostVulnerabilitiesComponent', () => {
  let component: HostVulnerabilitiesComponent;
  let fixture: ComponentFixture<HostVulnerabilitiesComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HostVulnerabilitiesComponent);
