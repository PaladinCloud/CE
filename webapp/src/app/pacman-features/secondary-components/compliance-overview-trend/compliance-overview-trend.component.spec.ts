...
import { ComplianceOverviewTrendComponent } from './compliance-overview-trend.component';

describe('ComplianceOverviewTrendComponent', () => {
  let component: ComplianceOverviewTrendComponent;
  let fixture: ComponentFixture<ComplianceOverviewTrendComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ComplianceOverviewTrendComponent);
