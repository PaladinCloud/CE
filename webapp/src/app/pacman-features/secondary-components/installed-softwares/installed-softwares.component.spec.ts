...
import { InstalledSoftwaresComponent } from './installed-softwares.component';

describe('InstalledSoftwaresComponent', () => {
  let component: InstalledSoftwaresComponent;
  let fixture: ComponentFixture<InstalledSoftwaresComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(InstalledSoftwaresComponent);
