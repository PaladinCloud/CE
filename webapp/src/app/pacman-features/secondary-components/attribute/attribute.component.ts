            ...
            for (let i = 0; i < data.length; i++) {
                ...
                for (let j = 0; j < listData.length; j++) {
                    ...
                    if (listData[j] !== undefined) {
                        if (
                            listData[j].name === 'Load Date' ||
                            listData[j].name === 'Instance create time' ||
                            listData[j].name === 'Snapshot createtime' ||
                            listData[j].name === 'latestrestorabletime' ||
                            listData[j].name === 'createtime' ||
                            listData[j].name.toLowerCase() === 'starttime'
                        ) {
