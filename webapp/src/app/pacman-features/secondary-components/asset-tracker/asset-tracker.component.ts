...
export class AssetTrackerComponent implements OnInit, OnDestroy {
            ...
            .subscribe(
                (response) => {
                    try {
                        ...
                        if (
                            this.totaltagValue === undefined ||
                            this.totaltagValue == null ||
                            this.untagValue === undefined ||
                            this.untagValue == null ||
                            this.untagValue <= 0 ||
                            this.tagValue <= 0
                        ) {
                            this.barHeight = false;
    ...
    getCalculatedValues(): void {
        ...
        const RunSettimeout = setTimeout(function () {
            ...
            if (
                document.getElementsByClassName('total_issues_bar')[0] != null &&
                document.getElementsByClassName('loading_bar_right')[0] != null &&
                document.getElementsByClassName('left-count-value')[0] != null &&
                document.getElementsByClassName('right-count-value')[0] != null
            ) {
                x.leftWidthValue = document
                    .getElementsByClassName('total_issues_bar')[0]
                    .getBoundingClientRect().width;
                x.rightWidthValue = document
                    .getElementsByClassName('loading_bar_right')[0]
                    .getBoundingClientRect().width;
                x.leftLableWidth = document
                    .getElementsByClassName('left-count-value')[0]
                    .getBoundingClientRect().width;
                x.rightLableWidth = document
                    .getElementsByClassName('right-count-value')[0]
                    .getBoundingClientRect().width;
