...
import { Component, OnInit, OnDestroy, SimpleChanges, Input, OnChanges } from '@angular/core';
...
export class DigitalApplicationDistributionComponent implements OnInit, OnDestroy, OnChanges {
