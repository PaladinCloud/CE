...
export class AllPolicyViolationsComponent implements OnInit, OnDestroy {
        ...
        for (let row = 0; row < getData.length; row++) {
            ...
            for (let col = 0; col < getCols.length; col++) {
                if (
                    ...
                    getCols[col].toLowerCase() === 'asset id'
                ) {
                    cellObj = {
                        link: 'true',
                        properties: {
                    ...
                    getCols[col].toLowerCase() === 'violation id' ||
    ...
    goToDetails(row) {
        try {
            ...
            if (row.col.toLowerCase() === 'asset id') {
                ...
                this.router.navigate(
                    [
                        ...
                        encodeURIComponent(row.row['Asset ID'].text),
                    ],
                    {
                        relativeTo: this.activatedRoute,
                        queryParams: updatedQueryParams,
                ...
                row.col.toLowerCase() === 'violation id' ||
                ...
                this.router.navigate(
                    ['../../issue-listing/issue-details', row.row['Violation ID'].text],
                    {
                        relativeTo: this.activatedRoute,
                        queryParams: updatedQueryParams,
                        queryParamsHandling: 'merge',
