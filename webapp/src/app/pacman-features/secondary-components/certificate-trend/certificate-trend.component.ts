...
@Component({
  selector: 'app-certificate-trend',
  templateUrl: './certificate-trend.component.html',
  styleUrls: ['./certificate-trend.component.css'],
...
export class CertificateTrendComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('certificateHistoryContainer') widgetContainer: ElementRef;
    ...
    private yAxisLabel = 'Number of Policy Violations';
    ...
    onResize() {
        const element = document.getElementById('certificateTrend');
        if (element) {
