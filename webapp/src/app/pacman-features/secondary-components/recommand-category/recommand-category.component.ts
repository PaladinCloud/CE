        ...
        try {
            ...
            data.forEach((element, i) => {
                ...
                if (this.general === false) {
                    data[i]['Recommendation For'] =
                        element.recommended + ' out of ' + element.total + ' Assets';
                }
            });
            const getData = data;
        ...
        try {
            ...
            this.router.navigate(
                [
                    ...
                    row.row['Recommendation ID'].text,
                    row.row['recommendation'].text,
                    this.general,
                ],
