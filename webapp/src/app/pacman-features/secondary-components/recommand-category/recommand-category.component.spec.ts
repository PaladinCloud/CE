...
import { RecommandCategoryComponent } from './recommand-category.component';

describe('RecommandCategoryComponent', () => {
  let component: RecommandCategoryComponent;
  let fixture: ComponentFixture<RecommandCategoryComponent>;
