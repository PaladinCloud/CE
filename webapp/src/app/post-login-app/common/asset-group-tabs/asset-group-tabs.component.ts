            ...
            try {
                ...
                while (calcMore) {
                    if (remainingSpace > moreSpace) {
                        ...
                        remainingSpace =
                            remainingSpace +
                            innerTabs[this.assetTempTabName.length - 1].clientWidth;
                        this.assetTempTabName.pop();
                ...
                const selectedTabNameAvailability = this.utilService.findValueInArray(
                    this.assetTabName,
                ...
                const selectedTabPartOfMoreSection = this.utilService.findValueInArray(
                    this.moreArray,
                    this.selectedTabName,
                );
