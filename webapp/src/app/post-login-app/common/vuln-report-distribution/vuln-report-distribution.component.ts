...
export class VulnReportDistributionComponent
    implements OnInit, OnChanges, OnDestroy, AfterViewInit
{
    ...
    getInfraData() {
        ...
        this.InfraDataSubscription = this.commonResponseService
            ...
            .subscribe(
                (response) => {
                    try {
                        ...
                        if (
                            this.utilsService.checkIfAPIReturnedDataIsEmpty(response.distribution)
                        ) {
    ...
    getEnvData() {
        ...
        this.EnvDataSubscription = this.commonResponseService
            .getData(url, method, payload, queryParam)
            .subscribe(
                (response) => {
                    try {
    ...
    getVulnTypeData() {
        ...
        this.VulnTypeDataSubscription = this.commonResponseService
            .getData(url, method, payload, queryParam)
            .subscribe(
                (response) => {
                    try {
