...
describe('KnowYourDashboardComponent', () => {
  let component: KnowYourDashboardComponent;
  let fixture: ComponentFixture<KnowYourDashboardComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(KnowYourDashboardComponent);
