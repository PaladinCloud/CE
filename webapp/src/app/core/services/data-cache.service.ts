...
export class DataCacheService {
    ...
    public setUserDefaultAssetGroup(defaultAssetGroup) {
        ...
        if (defaultAssetGroup) {
            this.set(key, defaultAssetGroup);
        }
    }
