 ...
 */
 ...
 export const CONFIGURATIONS = {
   required: {
     ...
     domains: {
       PROD_BASE_URL: 'https://demo.paladincloud.io/api', // Expected values: domain where the API is deployed, ex: http://beta.pacbot.com/api
       STG_BASE_URL: 'https://demo.paladincloud.io/api', // Expected values: domain where the API is deployed, ex: http://stgbeta.pacbot.com/api
       DEV_BASE_URL: 'https://demo.paladincloud.io/api', // Expected values: domain where the API is deployed, ex: http://devbeta.pacbot.com/api
       CLOUD_BASE_URL:'https://demo.paladincloud.io/api', // Expected values: domain where the API is deployed
     },
     featureModules: {
