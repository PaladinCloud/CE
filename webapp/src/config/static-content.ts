...
export const CONTENT = {
  homePage: {
    ...
    productBrief:
      "A platform for continuous compliance monitoring, compliance reporting and security automation for Cloud.",
    applicationCore: [
      {
        title: "Assess",
        description:
    ...
    keyComponents: {
      ...
      components: [
        ...
        },
        {
          ...
          description:
            "Scheduled jobs run in AWS batch to collect cloud inventory",
        },
        {
          title: "Data Lake",
          description:
            APP_NAME +
            " data lake uses a variety of storage technologies offered by AWS, they include S3, Redshift, RDS and Elastic Search",
        },
      ],
    },
    contactUs: {},
