...
export const CONTENT = {
    homePage: {
        ...
        productBrief:
            'A platform for continuous monitoring of cloud services to help developers and security teams identify and remediate security risks in their cloud environments to protect their applications.',
        applicationCore: [
            {
                title: 'Assess',
                description:
                    APP_NAME +
                    ' continuously assess the state of the cloud and changes in real-time to assess our cloud security and governance policy compliance.',
            ...
            },
            {
                ...
                description:
                    APP_NAME +
                    ' provides an easy way to view, monitor and report on the security and compliance of the entire cloud eco-system.',
                icon: '/assets/icons/report-icon.svg',
            },
            {
                title: 'Remediate',
                description:
                    'With detailed contextual information about the compliance violation, remediation is quick with ' +
                    APP_NAME +
                    '. ' +
                    APP_NAME +
                    ' provides auto-fixes and one click fix options.',
            ...
            components: [
                {
                    ...
                    description:
                        APP_NAME +
                        ' rule engine is 100% serverless, built using Cloudwatch events, Lambda & Elastic Container Service',
                },
                {
                    title: 'UI',
                ...
                },
                {
                    title: 'Search Engine',
                    description:
                        'All analytics and omni search is powered by Elastic Search, ' +
                        APP_NAME +
                        ' Data Collectors and Aggregator',
                },
                {
                ...
                },
                {
                    ...
                    description:
                        APP_NAME +
                        ' data lake uses a variety of storage technologies offered by AWS, they include S3, RDS and Elastic Search',
                },
            ],
        },
        contactUs: {},
