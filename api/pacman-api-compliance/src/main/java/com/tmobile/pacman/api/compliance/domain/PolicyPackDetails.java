...
public class PolicyPackDetails {
    ...
    private String policyPackVersionNumber;
    ...
    public String getPolicyPackVersionNumber() {
        return policyPackVersionNumber;
    }

    public void setPolicyPackVersionNumber(String policyPackVersionNumber) {
        this.policyPackVersionNumber = policyPackVersionNumber;
    }
}
