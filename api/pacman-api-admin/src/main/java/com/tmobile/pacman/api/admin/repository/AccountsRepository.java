...
public interface AccountsRepository extends JpaRepository<AccountDetails, String> {
    ...
    @Query("SELECT a.accountId, a.accountName,a.assets, a.violations ,a.accountStatus, a.platform, a.createdBy, a.createdTime FROM AccountDetails a WHERE a.accountName LIKE %:filterValue% ")
    Page<AccountDetails> findByName(Pageable pageable,@Param("filterValue") String filterValue);

    @Query("SELECT a.accountId, a.accountName,a.assets, a.violations ,a.accountStatus, a.platform, a.createdBy, a.createdTime FROM AccountDetails a WHERE a.assets LIKE %:filterValue% ")
    Page<AccountDetails> findByAssets(Pageable pageable,@Param("filterValue") String filterValue);

    @Query("SELECT a.accountId, a.accountName,a.assets, a.violations ,a.accountStatus, a.platform, a.createdBy, a.createdTime FROM AccountDetails a WHERE a.violations LIKE %:filterValue% ")
    Page<AccountDetails> findByViolations(Pageable pageable,@Param("filterValue") String filterValue);

    @Query("SELECT a.accountId, a.accountName,a.assets, a.violations ,a.accountStatus, a.platform, a.createdBy, a.createdTime FROM AccountDetails a WHERE a.accountStatus LIKE %:filterValue% ")
    Page<AccountDetails> findByStatus(Pageable pageable,@Param("filterValue") String filterValue);

    @Query("SELECT a.accountId, a.accountName,a.assets, a.violations ,a.accountStatus, a.platform, a.createdBy, a.createdTime FROM AccountDetails a WHERE a.platform LIKE %:filterValue% ")
